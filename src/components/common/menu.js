...
<div id="dropdown" className="hidden text-base list-none bg-white w-75 border-gray-400 border-2 z-50">
    <ul class="py-1">
      <li>
        <a href="#" className="block py-2 px-3  text-lg text-gray-400 hover:bg-gray-100 text-left ">{props.firstItem}</a>
      </li>
      <li>
        <a href="#" className="block py-2 px-3 text-gray-400 text-lg hover:bg-gray-100 text-left ">{props.secondItem}</a>
      </li>
